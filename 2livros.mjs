...
class ProjetoLivro {
	...
	async getLivros() {
		...
		while (true) {
			var f = await fetch("https://digital-content-bff.sasdigital.com.br/v1/materials?pageNumber=" + index, {
				"headers": {
					"accept": "application/json, text/plain, */*",
	...
	async getTopics(livroId) {
		...
		while (true) {
			var f = await fetch("https://digital-content-bff.sasdigital.com.br/v1/materials/" + livroId + "?includeNotVisibleContents=true", {
				"headers": {
					"accept": "application/json, text/plain, */*",
					"authorization": this.auth
				},
	...
	async getImages(topicId, p) {
		...
		while (true) {
			var f = await fetch("https://pageflip.portalsas.com.br/" + topicId + "/files/large/" + index + ".jpg", {
				"headers": {
